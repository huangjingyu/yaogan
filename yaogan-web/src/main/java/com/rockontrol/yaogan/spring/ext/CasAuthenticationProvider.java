...
public class CasAuthenticationProvider implements AuthenticationProvider,
   ...
   public Authentication authenticate(Authentication authentication)
      ...
      if (authentication instanceof UsernamePasswordAuthenticationToken
            && (!CasAuthenticationFilter.CAS_STATEFUL_IDENTIFIER.equals(authentication
                  .getPrincipal().toString()) && !CasAuthenticationFilter.CAS_STATELESS_IDENTIFIER
      ...
      if (authentication instanceof CasAuthenticationToken) {
         if (this.key.hashCode() == ((CasAuthenticationToken) authentication)
            ...
            throw new BadCredentialsException(
                  messages
                        .getMessage("CasAuthenticationProvider.incorrectKey",
   ...
   private CasAuthenticationToken authenticateNow(final Authentication authentication)
      ...
      try {
         final Assertion assertion = this.ticketValidator.validate(authentication
               .getCredentials().toString(), serviceProperties.getService());
